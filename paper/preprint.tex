...
\sixsix-clean exported to ONNX (286~MB asset; debug APK 365~MB), ONNX Runtime Mobile CPU, fp32 inference of bf16 weights (no quantization), v2 sampler ported, diffusion visualized (Figure~\ref{fig:app}).
